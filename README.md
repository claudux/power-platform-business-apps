...
```mermaid
flowchart LR
    A[Usuario ingresa a la app] --> B[Registro y validacion de datos]
    B --> C[Gestion del proceso]
    C --> D[Integracion con flujos y documentos]
    D --> E[Notificaciones y seguimiento]
    E --> F[Cierre y control del proceso]
```
